...
def get_last_score():
    ...
    db_res_item = db_res['Items'][0]
    return {
        'score': db_res_item['group_total'],
        'group_avg': db_res_item['group_avg'],
        'num_people': db_res_item['num_people'],
        'rek_max': db_res_item['rek_max'],
        'rek_avg': db_res_item['rek_avg']
    }
